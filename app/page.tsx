  ...
  return (
    <main>
     <div className="grid grid-cols-1 grid-flow-row-dense md:grid-cols-4 gap-6 m-6">
        ...
        <GridOption title="Shop Electronics" 
        ...
        <GridOption title="All you need for the Match Day" 
